...
class SkydioObstacleEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # The drone is moving at 5hz, so we need to check for collisions at 1000hz to avoid tunneling through walls. We do this by simulating 20 steps of physics and checking for contacts at each step. Not by checking with stepping rate of the drone but checking with stepping rate of the environment.
