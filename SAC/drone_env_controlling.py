...
class SkydioNavigateEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Apply the action for 20 physics frames (0.02 seconds)
        # Environment runs at 1000 Hz
        for _ in range(20):
        ...
        local_ang_vel = obs[7:10] # Extract the spin/wobble
        ...
        # Punishes the drone if it starts spinning out of control
